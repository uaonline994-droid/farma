...
const SHOP_ITEMS: ShopItem[] = [
  ...
  // 👑 Офіційні Титули та Теги Бота
  {
    ...
    price: 3000,
    unit: "титул",
    description: "Ранг початкового водія",
  },
  {
    id: "traktor",
    category: "titles",
    name: "Титул: Тракторист 🚜",
    icon: "🚜",
    price: 3500,
    unit: "титул",
    description: "Майстер польової техніки",
  },
  {
    id: "agronom",
    category: "titles",
  ...
  },
  {
    ...
    price: 5000,
    unit: "титул",
    description: "Експерт молочного тваринництва",
  },
  {
    id: "pasechnik",
    category: "titles",
    ...
    price: 6000,
    unit: "титул",
    description: "Майстер меду та природи",
  },
  {
    id: "fermer",
    category: "titles",
  ...
  },
  {
    ...
    price: 20000,
    unit: "титул",
    description: "Власник великих угідь та підприємств",
  },
  {
    id: "agrarniy",
    category: "titles",
    name: "Титул: Аграрний Барон 🌟",
    icon: "🌟",
    price: 30000,
    unit: "титул",
    description: "Лідер агропромислового сектору",
  },
  {
    id: "millioner",
    category: "titles",
    name: "Титул: Мільйонер 💰",
    icon: "💰",
    price: 50000,
    unit: "титул",
    description: "Престижний статус мільйонера",
  },
  {
    id: "custom",
    category: "titles",
    ...
    price: 100000,
    unit: "тег",
    description: "Індивідуальний тег для профілю",
  },
];
