...
export const Header: React.FC<{ onRefresh: () => void; isRefreshing?: boolean }> = ({
  ...
  return (
    <header className="sticky top-0 z-30 bg-[#244828]/95 backdrop-blur-md border-b border-[#3b7340] text-amber-50 px-3 py-2.5 shadow-lg">
      <div className="max-w-xl mx-auto flex flex-col gap-2">
        ...
        {/* Row 2: Secondary Quick Status Bar (Storage & Tag) */}
        <div className="flex items-center justify-between text-[11px] bg-[#1a331c]/90 px-2.5 py-1 rounded-lg border border-emerald-800/60">
          <div className="flex items-center gap-1.5 text-emerald-200">
            ...
            <div className="w-16 h-1.5 bg-emerald-950 rounded-full overflow-hidden inline-block ml-1 border border-emerald-700/40">
              <div
                className={`h-full rounded-full transition-all ${
                  storagePercent > 85 ? "bg-red-500" : "bg-amber-400"
                }`}
